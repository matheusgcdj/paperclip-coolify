...
export function BubbleCopyButton({ copyText }: { copyText: string }) {
  ...
  const label = failed ? t("Couldn’t copy message") : t("Copy message");
    ...
    <div className={cn("mt-2 flex items-center gap-1", className)}>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem
            onClick={() => {
              void copyWithToast(copyText, t("Message copied"));
            }}
          >
            ...
            >
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    {t("Choose whether voted AI outputs can be shared with Paperclip Labs.")}
                    {" "}
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <p>
                    Choose <span className="font-medium text-foreground">{t("Always allow")}</span> to share
                    this vote and future voted AI outputs. Choose{" "}
                    <span className="font-medium text-foreground">{t("Don't allow")}</span> to keep this vote
                    and future votes local.
                  </p>
                  <p>{t("You can change this later in Settings > General.")}</p>
                  {termsUrl ? (
                    <a
                      href={termsUrl}
                      target="_blank"
